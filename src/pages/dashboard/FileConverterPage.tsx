      ...
      <div className="mx-auto max-w-4xl">
        <header className="mb-10 text-center">
          ...
          <p className="text-lg text-gray-400">
            Transform and optimize your images in just a few clicks.
          </p>
        </header>
        ...
        <form onSubmit={handleSubmit} className="rounded-2xl border border-gray-800 bg-gray-900 p-6 sm:p-8">
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              disabled={isLoading}
              className="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-6 py-3 font-medium text-white transition-colors hover:bg-indigo-700 disabled:opacity-70"
            >
